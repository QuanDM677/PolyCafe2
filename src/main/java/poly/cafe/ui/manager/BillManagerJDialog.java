...
// Kiểm tra người tạo có tồn tại
    ...
    public void setForm(Bill entity) {
        ...
        // Disable radio button nếu trạng thái KHÔNG phải đang phục vụ
        boolean canEditStatus = (entity.getStatus() == 0);
        rdoBaoTri.setEnabled(canEditStatus);
        rdoHoanThanh.setEnabled(canEditStatus);
        rdoDaHuy.setEnabled(canEditStatus);
